...
export default function ImpactMetrics({ metrics }: ImpactMetricsProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div className="impact-card border-blue-500 rounded-2xl p-6 card-hover">
        <div className="flex items-center mb-6">
          <div className="w-16 h-16 bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg">
            <span className="text-3xl font-bold text-white">W</span>
          </div>
          <div className="ml-4">
            <h3 className="text-lg font-bold text-gray-900">Stormwater</h3>
            <p className="text-sm text-gray-600 font-medium">Runoff Reduction</p>
          </div>
        </div>
        ...
        <p className="text-sm text-gray-600 font-medium mb-3">per year</p>
      ...
      {/* CO2 Sequestration */}
      <div className="impact-card border-green-500 rounded-2xl p-6 card-hover">
        <div className="flex items-center mb-6">
          <div className="w-16 h-16 bg-gradient-to-br from-green-400 to-green-600 rounded-2xl flex items-center justify-center shadow-lg">
            <span className="text-3xl font-bold text-white">C</span>
          </div>
          <div className="ml-4">
            <h3 className="text-lg font-bold text-gray-900">Carbon</h3>
            <p className="text-sm text-gray-600 font-medium">Sequestration</p>
          </div>
        </div>
        ...
        <p className="text-sm text-gray-600 font-medium mb-3">CO₂ per year</p>
        <p className="text-xs text-gray-500 leading-relaxed">
      ...
      <div className="impact-card border-purple-500 rounded-2xl p-6 card-hover">
        <div className="flex items-center mb-6">
          ...
          <div className="ml-4">
            <h3 className="text-lg font-bold text-gray-900">Biodiversity</h3>
            <p className="text-sm text-gray-600 font-medium">Support Level</p>
          </div>
        </div>
      ...
      {/* Air Quality */}
      <div className="impact-card border-orange-500 rounded-2xl p-6 card-hover">
        <div className="flex items-center mb-6">
          ...
          <div className="ml-4">
            <h3 className="text-lg font-bold text-gray-900">Air Quality</h3>
        ...
        <p className="text-sm text-gray-600 font-medium mb-3">pollutant reduction</p>
        <p className="text-xs text-gray-500 leading-relaxed">
